...
% Custom commands
\newcommand{\AUTHOR}{M. Wieland, D. Kessler, R. Pfister, L. Röllin \& D. Thoma}
\newcommand{\INSTITUTE}{Hochschule für Technik Rapperswil}
\newcommand{\LICENSEURL}{https://en.wikipedia.org/wiki/Beerware}
\newcommand{\LICENSE}{
"THE BEER-WARE LICENSE" (Revision 42): As long as you retain this notice you can do whatever you want with this stuff. If we meet some day, and you think this stuff is worth it, you can buy me a beer in return. Michael Wieland	
}
...
\newcommand{\SUBJECT}{Bibel}
\newcommand{\TITLE}{MsTe - Microsoft Technologien}
...
Eine Enumeration ist eine vordefinierte Liste von Konstanten mit einem optionalen Wert. Enum leitet von Int32 ab. Um Speicherplatz zu sparen, könnte man auch von byte, sbyte, short etc erben. (Sollte nicht gemacht werden). % TODO warum?)
...
% TODO: Generic Delegates (und Action, Func, Predicate), V06 S.38ff => aus Übung Code-Teile mitnehmen
...
% TODO: Evtl. mehr beispiele. z.B. mit Skip, Take etc. oder aus Übungen 08 S 17
...
\subsubsection{Fault Implementation}
\begin{lstlisting}
using System;
...
// Client Class
public class CallbackHandler : ICalcCallback
{
...
// Wird für Proxy Erzeugung benötigt
